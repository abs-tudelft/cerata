...
/// \brief Return a human-readable string of an unordered map of with string k/vs.
...
template<typename T>
bool Contains(const std::vector<std::shared_ptr<T>> &list,
 ...
 */
template<typename T>
std::string ToString() { return "UNKNOWN TYPE"; }

/// \brief Create a directory.
[[nodiscard]] Status CreateDir(const std::filesystem::path &dir_name);
